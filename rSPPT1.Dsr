VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} rSPPT1 
   ClientHeight    =   9750
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   14985
   OleObjectBlob   =   "rSPPT1.dsx":0000
End
Attribute VB_Name = "rSPPT1"
...
If UCase(Trim(Field28.Value)) = "00" Or UCase(Trim(Field28.Value)) = "0" Or UCase(Trim(Field28.Value)) = "-" Or UCase(Trim(Field28.Value)) = "" Then
    Field28.Suppress = True
    Text1.Suppress = True
    Field25.Top = 2445
Else
    Field28.Suppress = False
